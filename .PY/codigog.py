...
def selectCase(int_COD):    

    if int_COD == "55": return " Chernobyl "
    
    elif int_COD == "51": return " Uruguay "

    elif int_COD == "56": return " Portugal "

    elif int_COD == "57": return " Paquistão "

    elif int_COD == "58": return " China "


def selecCase01(int_PROD):

    if int_PROD == "666": return " Pepsi "
    
    elif int_PROD == "777": return " Coca  "

    elif int_PROD == "888": return " Fanta "

    elif int_PROD == "555": return " Guarana "

    elif int_PROD == "999": return " Dolly "
    

def selectCase02(int_VAL):

    if int_VAL == "151": return " 25/03/2022 "

    elif int_VAL == "515": return " 26/04/2022"

    elif int_VAL == "161": return " 27/05/2022"

    elif int_VAL == "616": return " 28/06/2022"

    elif int_VAL == "252": return " 25/01/2023"

while True :
    print("COD")

    cidade = input()
    print(selectCase(cidade))



    produto = input()
    print(selecCase01(produto))
